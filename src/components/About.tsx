          ...
          <AnimatedSection direction="left" delay={200}>
            <div className="flex justify-center lg:justify-start">
              <div className="relative">
                <div className="w-64 h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 rounded-2xl overflow-hidden relative">
                  {/* Placeholder for photo - replace with actual image */}
                  <div className={`w-full h-full ${
                    darkMode ? 'bg-gradient-to-br from-gray-700 to-gray-800' : 'bg-gradient-to-br from-gray-200 to-gray-300'
                  } flex items-center justify-center`}>
                    <User className={`w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 ${darkMode ? 'text-gray-500' : 'text-gray-400'}`} />
                    <div className="absolute inset-0 flex items-center justify-center">
                      <span className={`text-sm sm:text-base md:text-lg font-medium ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                       <img 
          ...
          <AnimatedSection direction="right" delay={400}>
            <div className="space-y-8">
              ...
              <div className={`p-6 rounded-xl ${darkMode ? 'bg-gray-800' : 'bg-gray-50'}`}>
                <p className={`text-sm sm:text-base md:text-lg leading-relaxed ${darkMode ? 'text-gray-300' : 'text-gray-800'}`}>
